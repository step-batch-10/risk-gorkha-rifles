...
import TerritoryManager, { Continents, PlayerRegion, TerritoryState } from "../../src/core/territoryManager.ts";
...
describe('getPlayerRegions', () => {
  const territoryManager = createTerritoryManagerInstance();
  const player1Regions: PlayerRegion = territoryManager.getPlayerRegions('1');
  const player2Regions: PlayerRegion = territoryManager.getPlayerRegions('2');
  const player3Regions: PlayerRegion = territoryManager.getPlayerRegions('3');
